  ...
  <body>
   ...
   @else
    ...
    <div class="sl-sideleft">
      <label class="sidebar-label">Ecommerce</label>
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Cupons Setup</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('cupons')}}" class="nav-link">Cupon</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('newslatter')}}" class="nav-link">News Latter</a></li>
